...
def test_waveform():
    ...
    value = np.array([1,2,3,4, 2**32-1, 2**32 , 2**64-2, 2**64-1], dtype=np.uint64)
    width = 64
    clock = np.arange(len(value))
    time = clock * 10
    a = Waveform(value, clock, time, width = width, signed = False)
    ...
    width = 128
    value = np.array([1,2,3,4, 2**32-1, 2**32 , 2**64-2, 2**64-1, 2**66, 2**128-1])
    a = Waveform(value, clock, time, width = width, signed = False)
    ...
    value = np.array([1,2,3,4, 0, 666,100, 200, 333, 444, 1023, 1999, 99999], dtype=np.uint64)
    ...
    value = np.array([1,2,3,4, 0, 666,100, 200, 333, 444, 1023, 1999 ], dtype=np.uint64)
    values = [value, value + 1234, value + 9999]
    width = [16, 20, 21]
    clock = np.arange(len(value))
    time = clock * 10
    waves = [Waveform(v, clock, time, width = w, signed = False) for v,w in zip(values, width)]
    concat_values = (values[0] + (values[1] << width[0]) + (values[2] << (width[0] + width[1])))
    ...
    value = np.array([1,2,3,4, 0, 666,100, 200, 333, 444, 1023, 1999 ], dtype=np.object_)
