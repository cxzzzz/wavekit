...
`endif
  ...
  initial begin
    ...
    dut.unit_a.asc_zero         = 4'b1100;
    dut.unit_a.asc_nonzero      = 3'b110;
    dut.unit_a.desc_nonzero     = 3'b110;
    ...
    dut.unit_b.asc_zero         = 4'b0011;
    dut.unit_b.asc_nonzero      = 3'b001;
    dut.unit_b.desc_nonzero     = 3'b001;
    ...
    dut.unit_a.asc_zero = 4'b0011;
    dut.unit_a.asc_nonzero = 3'b001;
    dut.unit_a.desc_nonzero = 3'b001;
    ...
    dut.unit_b.asc_zero = 4'b1100;
    dut.unit_b.asc_nonzero = 3'b110;
    dut.unit_b.desc_nonzero = 3'b110;
