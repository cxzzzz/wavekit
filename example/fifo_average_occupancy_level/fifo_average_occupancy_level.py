...
with VcdReader('fifo_tb.vcd') as f:
    ...
    w_ptr = f.load_wave('fifo_tb.s_fifo.w_ptr[2:0]', clock=clock)
    r_ptr = f.load_wave('fifo_tb.s_fifo.r_ptr[2:0]', clock=clock)
    ...
    w_en = f.load_wave('fifo_tb.s_fifo.w_en', clock=clock)
    full = f.load_wave('fifo_tb.s_fifo.full', clock=clock)
