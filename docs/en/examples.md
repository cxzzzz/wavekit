...
| [Scoreboard](https://github.com/cxzzzz/wavekit/tree/main/example/scoreboard/) | Verify FIFO data integrity and ordering between writes and reads | Dict-style signal access; waveform filtering; indexed extraction; NumPy interoperability | `make -C example/scoreboard all` |
| [Multi-cluster occupancy](https://github.com/cxzzzz/wavekit/tree/main/example/multi_cluster_occupancy/) | Compare FIFO occupancy across a bank of clusters | Batch signal queries; cross-level scope matching | `make -C example/multi_cluster_occupancy all` |
